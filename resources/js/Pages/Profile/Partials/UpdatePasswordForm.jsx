...
export default function UpdatePasswordForm({ className = '' }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Modifier mon mot de passe</h2>

                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Assurez vous que votre mot de passe sois le plus long et le plus difficile à deviner possible.
                </p>
            </header>
